...
class Funcs(): #classe que terá os metodos para o funcionamento dos botões 
    ...
    def busca_produto(self):
        ...
        self.variaveis()
        self.cursor.execute(""" SELECT ID, nome_produto, quantidade, laboratorio, preco, modo_pagamento, vendedor, total FROM produtos WHERE nome_produto LIKE '%s' ORDER BY nome_produto ASC """ % self.nome)
